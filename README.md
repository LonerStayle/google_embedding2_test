...
1. **이미지 개별 검색 시 컨텍스트 부재 문제** — 이미지만 임베딩하면 캡션/주변 텍스트 정보가 없어 검색 품질 저하
2. **멀티모달 조합 임베딩** — 이미지+텍스트를 한 Content에 묶어 임베딩하면 컨텍스트 보강 가능 
